...
- Use the managed Codex backend default. Do not pass a backend unless checking or explaining a rejection; the guarded runner sources `global-skill.env` and enforces Codex.
